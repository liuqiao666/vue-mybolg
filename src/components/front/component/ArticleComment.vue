<template>
    <div id='comment'>
        <div class='newComment'>
            ...
            <textarea spellcheck='false' placeholder='来来来，请说出你的想法......' v-model='content' id='reply' ref='textBox'></textarea>
            <div class="inputBox">
                <input type='text' placeholder='邮箱 (用于通知)' v-model='address'/>
                <input type='text' placeholder='你的用户名(用于称呼)' v-model='name' class='name' id='nameBox'/>
    ...
    methods: {
        ...
        summit () {
            ...
            if (this.content.length > 500) {
                ...
                this.set_dialog({
                    info: '请不要发表灌水、广告、违法、Q群Q号等信息，不然巧姐可能会打你喔~',
                    hasTwoBtn: false,
                    show: true
                })
                return false
